...
import {
  ...
  export default function PatientdetailsReducer(
    ...
    console.log('blog789',payload,state);
    ...
    switch (type) {
      ...
      //   };
        ...
        case GET_EMP_CALENDER_REQUEST:
          return {
            ...state,
            AllProducts: { loading: true, error: false,message:payload },
          };
        case  GET_EMP_CALENDER_SUCCESS:
          return {
            ...state,
            AllProducts: { loading: false, error: false },
            data: [...payload],
