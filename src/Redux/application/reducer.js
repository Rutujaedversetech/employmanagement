...
import {
  ...
  export default function PatientdetailsReducer(
   ...
   console.log('appblog',payload,state);
    ...
    switch (type) {
      ...
      //   };
        ...
        case GET_EMP_APPLICATION_REQUEST:
          return {
            ...state,
            AllProducts: { loading: true, error: false },
          };
        case  GET_EMP_APPLICATION_SUCCESS:
          return {
            ...state,
            AllProducts: { loading: false, error: false },
            data: [...payload],
        ...
        case  GET_EMP_APPLICATION_FAILURE:
          return {
            ...state,
            AllProducts: { loading: false, error: true },
          };
      ...
      case UPDATE_APPLICATION_SUCCESS:
        return {
          ...
          //console.log('item',item)
            item.candidate_id == payload.candidate_id ? payload : item
          ),
        };
