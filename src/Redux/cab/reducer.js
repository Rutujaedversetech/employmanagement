import {
  ...
  export default function PatientdetailsReducer(
    ...
    console.log('cabop',payload,state);
    ...
    switch (type) {
      ...
      //   };
        ...
        case GET_EMP_CAB_REQUEST:
          return {
            ...state,
            AllProducts: { loading: true, error: false },
          };
        case  GET_EMP_CAB_SUCCESS:
          return {
            ...state,
            AllProducts: { loading: false, error: false },
            data: [...payload],
      ...
      case ADD_CAB_REQUEST:
        return {
          ...state,
          AddProduct: { loading: 'xcv', error: false,message:'' },
        };
      case ADD_CAB_SUCCESS:

        return {
          ...state,
          AddProduct: { loading: false, error: false,message:'cab added'  },
          data: [...state.data, payload.data.response],
        };
  
      case ADD_CAB_FAILURE:
        return {
          ...state,
          AddProduct: { loading: false, error: true,message:'' },
        };
