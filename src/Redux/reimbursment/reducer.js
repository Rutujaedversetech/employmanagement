import { GET_EMP_REFERRAL_FAILURE, GET_EMP_REFERRAL_SUCCESS } from "../referral/actionTypes";
import {
    // ADD_PRODUCT_FAILURE,
    // ADD_PRODUCT_REQUEST,
    // ADD_PRODUCT_SUCCESS,
  ...
  export default function PatientdetailsReducer(
   ...
   console.log('remblog',payload,state);
    ...
    switch (type) {
      ...
      //   };
        ...
        case GET_EMP_REIMBURSEMENT_REQUEST:
          return {
            ...state,
            AllProducts: { loading: true, error: false },
          };
        case  GET_EMP_REIMBURSEMENT_SUCCESS:
          return {
            ...state,
            AllProducts: { loading: false, error: false },
            data: [...payload],
        ...
        case  GET_EMP_REIMBURSEMENT_FAILURE:
          return {
            ...state,
            AllProducts: { loading: false, error: true },
          };
      ...
      case ADD_REIMBURSEMENT_REQUEST:
        return {
          ...state,
          AddProduct: { loading: true, error: false,message:'' },
        };
      case ADD_REIMBURSEMENT_SUCCESS:
      ...
      case ADD_REIMBURSEMENT_FAILURE:
        return {
          ...state,
          AddProduct: { loading: false, error: true,message:'' },
        };
      ...
      case DELETE_REIMBURSEMENT_REQUEST:
        return {
          ...state,
          DeleteProduct: { loading: true, error: false },
        };
      case DELETE_REIMBURSEMENT_SUCCESS:
        return {
          ...state,
          DeleteProduct: { loading: false, error: false,message:"delete" },
          data: state.data.filter((item) => item._id !== payload),
        };
  
      case DELETE_REIMBURSEMENT_FAILURE:
        return {
          ...state,
