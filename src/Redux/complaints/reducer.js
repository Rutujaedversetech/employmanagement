  ...
  export default function PatientdetailsReducer(
    ...
    switch (type) {
      ...
      //   };
        ...
        case GET_EMP_COMPLAINT_REQUEST:
          return {
            ...state,
            AllProducts: { loading: true, error: false },
          };
        case  GET_EMP_COMPLAINT_SUCCESS:
          return {
            ...state,
            AllProducts: { loading: false, error: false },
            data: [...payload],
        ...
        case  GET_EMP_COMPLAINT_FAILURE:
          return {
            ...state,
            AllProducts: { loading: false, error: true },
          };
      ...
      case ADD_COMPLAINT_SUCCESS:
        ...
        return {
          ...state,
          AddProduct: { loading: false, error: false,message:'complaint added'  },
      ...
      case UPDATE_COMPLAINT_SUCCESS:
        return {
          ...
          //console.log('item',item)
            item.complaint_id == payload.complaint_id ? payload : item
          ),
        };
