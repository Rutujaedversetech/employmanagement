import {
  ...
  export default function PatientdetailsReducer(
    ...
    console.log('taskblog',payload,state);
    ...
    switch (type) {
      ...
      //   };
        ...
        case  GET_EMP_TASK_FAILURE:
          return {
            ...state,
            AllProducts: { loading: false, error: true },
          };
    
          case GET_EMP_ASSIGNEDTASK_REQUEST:
            return {
              ...state,
              AllProducts: { loading: true, error: false },
            };
          case  GET_EMP_ASSIGNEDTASK_SUCCESS:
            return {
              ...state,
              AllProducts: { loading: false, error: false },
          ...
          case  GET_EMP_ASSIGNEDTASK_FAILURE:
            return {
              ...state,
              AllProducts: { loading: false, error: true },
            };
      ...
      case UPDATE_TASK_SUCCESS:
        return {
          ...
          item.task_id == payload.task_id ? payload : item
          ),
        };
