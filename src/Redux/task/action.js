...
import {
  ...
  GET_EMP_TASK_REQUEST,
  GET_EMP_TASK_SUCCESS,
  GET_EMP_TASK_FAILURE,
  ADD_TASK_REQUEST,
  ADD_TASK_SUCCESS,
  ADD_TASK_FAILURE,
  UPDATE_TASK_REQUEST,
  ...
  DELETE_TASK_SUCCESS,
  DELETE_TASK_FAILURE,
  GET_EMP_ASSIGNEDTASK_REQUEST,
  GET_EMP_ASSIGNEDTASK_SUCCESS,
  GET_EMP_ASSIGNEDTASK_FAILURE,
  GET_EMP_COMDTASK_REQUEST,
  GET_EMP_COMDTASK_SUCCESS,
  GET_EMP_COMDTASK_FAILURE,
...
export const getempongoingTASK = (id) => async (dispatch) => {
  //console.log('is',iid);
  //var id=id
    //console.log('is',id);
   // const token=localStorage.getItem("token")
  ...
  try {
    dispatch({ type: GET_EMP_TASK_REQUEST });

    
    // const res=  await fetch(`http://68.178.169.96:3000/tasks/emp_id?emp_id=${id}`, {
      const res=  await fetch(`http://68.178.169.96:3000/tasks`, {
...
//console.log('fgh123',res.data);
    dispatch({ type: GET_EMP_TASK_SUCCESS, payload: data.response });
  } catch (error) {
    dispatch({
      type: GET_EMP_TASK_FAILURE,
    });
  }
};


//task assignedby to id

export const getempASSIGNEDTASK = (id) => async (dispatch) => {
  //console.log('is',iid);
  //var id=id
    //console.log('is',id);
   // const token=localStorage.getItem("token")
  ...
  try {
    dispatch({ type: GET_EMP_ASSIGNEDTASK_REQUEST });

    
    const res=  await fetch(`http://68.178.169.96:3000/tasks/task_assign_by?task_assign_by=Emp004`, {
      // body: JSON.stringify(res),
      method: "GET",
...
console.log('fgh123',data);
//console.log('fgh123',res.data);
    dispatch({ type: GET_EMP_ASSIGNEDTASK_SUCCESS, payload: data.response });
  } catch (error) {
    dispatch({
      type: GET_EMP_ASSIGNEDTASK_FAILURE,
    });
  }
};
...
export const getempCOMPLETEDTASK = (id) => async (dispatch) => {
  //console.log('is',iid);
  //var id=id
    //console.log('is',id);
   // const token=localStorage.getItem("token")
  ...
  try {
    dispatch({ type: GET_EMP_COMDTASK_REQUEST });
...
console.log('fgh123',data);
//console.log('fgh123',res.data);
    dispatch({ type: GET_EMP_COMDTASK_SUCCESS, payload: data.response });
  } catch (error) {
    dispatch({
      type: GET_EMP_COMDTASK_FAILURE,
    });
  }
};
...
export const addempTASK = (formData,id) => async (dispatch) => {
  const headers = {
...
export const updateTASKStatus = (id, data) => async (dispatch) => {
  console.log('opp',data);
  try {
    dispatch({ type: UPDATE_TASK_REQUEST });

    await fetch(`http://68.178.169.96:3000/tasks/${id}`, {
