import {
  ...
  export default function PatientdetailsReducer(
   ...
   console.log('refblog',payload,state);
    ...
    switch (type) {
      ...
      //   };
        ...
        case GET_EMP_REFERRAL_REQUEST:
          return {
            ...state,
            AllProducts: { loading: true, error: false },
          };
        case  GET_EMP_REFERRAL_SUCCESS:
          return {
            ...state,
            AllProducts: { loading: false, error: false },
            data: [...payload],
