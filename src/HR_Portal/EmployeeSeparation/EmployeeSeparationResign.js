...
const EmployeeSeparationResign = () => {
        ...
        <Box mt={'2%'} ml={'26%'} w={'50%'} h={'92vh'} boxShadow='0px 5px 20px 0px #00000026' borderRadius={'28px'}>
            ...
            <Flex w={'100%'} h={'64vh'}>
                ...
                <FormControl mt={'6%'} ml={'-95%'} w={'90%'} fontFamily={'Inter'}>
                    ...
                    <Input onChange={(e) => setresigned_date(e.target.value)} boxShadow='0px 5px 20px 0px #00000026' />
...
export default EmployeeSeparationResign;